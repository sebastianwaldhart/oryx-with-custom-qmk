...
tap_dance_action_t tap_dance_actions[] = {
  [ACC_A] = ACTION_TAP_DANCE_DOUBLE(DE_AE, UP(MARK_A_LOWER, MARK_A_UPPER)),
  [ACC_O] = ACTION_TAP_DANCE_DOUBLE(DE_OE, UP(MARK_O_LOWER, MARK_O_UPPER)),
  [ACC_U] = ACTION_TAP_DANCE_DOUBLE(DE_UE, UP(MARK_U_LOWER, MARK_U_UPPER)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER6] = LAYOUT_planck_grid(
    DE_CIRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DE_EURO,        KC_TRANSPARENT, KC_TRANSPARENT, UP(INV_EX, INV_QU),         
    KC_TRANSPARENT, TD(ACC_A),          TD(ACC_O),          UP(MARK_E_LOWER, MARK_E_UPPER), TD(ACC_U),          UP(MARK_I_LOWER, MARK_I_UPPER), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, UP(NJ_LOWER, NJ_UPPER), DE_SS,          KC_TRANSPARENT, 
