...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER6] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO, KC_TRANSPARENT, KC_NO,          KC_TRANSPARENT, KC_RIGHT_ALT,   UC(DBL_LEFT), UC(DBL_RIGHT), KC_TRANSPARENT
  ),
